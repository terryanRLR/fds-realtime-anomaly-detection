...
title FDS Team Server - ALL (dashboard.py + ops_dashboard.py)

set "LOGFILE=%~dp0start_fds_all_log.txt"
echo ============================================== > "%LOGFILE%"
echo  start_fds_all.bat - %date% %time% >> "%LOGFILE%"
echo ============================================== >> "%LOGFILE%"
...
set NGROK_ENABLE=1
set TUNNEL_TARGET=dashboard

call "%~dp0fds_config.bat"

echo.
echo  ================================================
echo    FDS Team Server - ALL SERVICES
echo  ================================================
echo.
...
echo  ================================================
echo   dashboard.py      : http://localhost:%DASHBOARD_PORT%
echo   ops_dashboard.py  : http://localhost:%OPS_PORT%
...
if "%NGROK_ENABLE%"=="1" (
    ...
    echo   ^(To tunnel the other one instead, change TUNNEL_TARGET at the top
    echo    of this script, or buy an ngrok plan with multiple tunnels.^)
)
echo.
